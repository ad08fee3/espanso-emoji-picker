...
* Unicode 17 is getting support soon - add support for that. https://github.com/ad08fee3/espanso-emoji-picker/issues/1
...
* If the user types an EXACT match, that match should be at the top of the list. As long as we have to have the emoji *and* the emoji name in the label, I don't know if this is possible.
